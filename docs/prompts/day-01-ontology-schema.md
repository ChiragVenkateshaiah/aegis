...
```text
You are working inside the AEGIS repository, an AI-powered credit memo / underwriting co-pilot for SME lending. Today is Day 1 of an 8-week build. Read PROJECT_SPEC.md, PHASES.md, DECISIONS.md, WORKFLOW.md, WEEK_01_TASKS.md, and docs/adr/0009-day1-ontology-first.md before doing anything else. Also read docs/reference/aegis-project-spec.md and docs/reference/aegis-ontology.svg for visual context.
